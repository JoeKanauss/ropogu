...
<div class="container">
	...
	<div class="delete-section">
		...
		<div class="to-delete">
			<p><span class="from">FROM: <?php echo $pmData[0]['username'];?></span></br>
			<?php echo $pmData['message'];?></p>
			
		</div>
		
		<form action="<?php echo $_SERVER['SCRIPT_NAME']; ?>?pm_id=<?php echo $_REQUEST['pm_id'];?>" method="post">
			<input type="radio" name="delete" value="yes">Yes, delete this letter<br>
			<input type="radio" name="delete" value="no">No, keep this letter<br>
